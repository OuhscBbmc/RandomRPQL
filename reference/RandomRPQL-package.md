# Variable selection method for GLMMs
...
- *OUHSC CCAN Independent Evaluation of the State of Oklahoma
  ...
  ([MIECHV](https://mchb.hrsa.gov/maternal-child-health-initiatives/home-visiting-overview))
...
The release version is not yet available. It will be available through
[CRAN](https://cran.r-project.org/package=RandomRPQL) by running
`install.packages('RandomRPQL')`. The most recent development version is
available through [GitHub](https://github.com/OuhscBbmc/RandomRPQL) by
running `remotes::install_github('OuhscBbmc/RandomRPQL')` (make sure
...
create a [new issue](https://github.com/OuhscBbmc/RandomRPQL/issues), or
email Will.
